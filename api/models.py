...
class authorMeta(models.Model):
    ...
    related_persons = models.ManyToManyField(
        ...
        through_fields=("person_a_id", "person_b_id"),
...
class textMeta(models.Model):
    ...
    related_texts = models.ManyToManyField(
        ...
        through="a2bRelation",
        # see https://docs.djangoproject.com/en/4.0/ref/models/fields/#django.db.models.ManyToManyField.through_fields
        through_fields=("text_a_id", "text_b_id"),
    ...
    related_persons = models.ManyToManyField(
        ...
        through="a2bRelation",
        # see https://docs.djangoproject.com/en/4.0/ref/models/fields/#django.db.models.ManyToManyField.through_fields
        through_fields=("text_a_id", "person_b_id"),
    )
    related_places = models.ManyToManyField(
        "placeMeta",
        # see https://docs.djangoproject.com/en/4.0/ref/models/fields/#django.db.models.ManyToManyField.through
        through="a2bRelation",
        # see https://docs.djangoproject.com/en/4.0/ref/models/fields/#django.db.models.ManyToManyField.through_fields
        through_fields=("text_a_id", "place_b_id"),
    )
...
class personName(models.Model):
    ...
    author_id = models.ForeignKey(authorMeta, related_name='personNames',
                                  related_query_name="personName", on_delete=models.DO_NOTHING)
...
class relationType(models.Model):
    ...
    parent_type = models.ManyToManyField(
        "self", symmetrical=False, related_name="sub_types", related_query_name="sub_type",)
    # person_person, place_place, person_place, ...
...
class a2bRelation (models.Model):
    ...
    relation_type = models.ForeignKey(
        relationType, on_delete=models.DO_NOTHING, null=True, blank=True)
