# Generated by Django 3.2.6 on 2023-07-28 09:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_1', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='textreuse_b1', related_query_name='textreuse_b1', to='api.releasemeta')),
                ('book_2', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='textreuse_b2', related_query_name='textreuse_b2', to='api.releasemeta')),
                ('release', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reuse_statistics', related_query_name='reuse_statistics', to='api.releasedetails')),
            ],
        ),
        migrations.AddField(
            model_name='releasemeta',
            name='version_meta',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='releases', related_query_name='release', to='api.versionmeta'),
        ),
        migrations.CreateModel(
            name='personName',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='corpus_statistics', related_query_name='corpus_statistics', to='api.releasedetails')),
            ],
        ),
        migrations.AddField(
